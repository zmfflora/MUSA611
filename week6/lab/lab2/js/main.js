...
var eachFeatureFunction = function(layer) {
  ...
  layer.on('click', function (event) {
    ...
    if(layer.options.fillColor==='#4DFF96'){
      $(".day-of-week").text("Tuesday");
    }
    if(layer.options.fillColor==='#3078CC'){
      $(".day-of-week").text("Wednesday");
    }
    if(layer.options.fillColor==="#6B9998"){
      $(".day-of-week").text("Thursday");
    }
    if(layer.options.fillColor==="#CC29A8"){
      $(".day-of-week").text("Friday");
    }
    if(layer.options.fillColor==="#FFD76D"){
      $(".day-of-week").text("Saturday");
    }
    if(layer.options.fillColor==="#99977E"){
